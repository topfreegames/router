...
| <a name="monitoring-cidr-or-ip"></a>deis-router | deployment | [router.deis.io/nginx.monitoringCIDRorIP](#monitoring-cidr-or-ip) | `"127.0.0.1"` |  Whitelists allowed clients by IP / CIDR range which can access nginx `/nginx_status` and `~ ^/stats/?$` routes. |
